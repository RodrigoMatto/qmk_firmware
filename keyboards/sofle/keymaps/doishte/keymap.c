...
[0] = LAYOUT(
  ...
  KC_F12,   KC_Q,   KC_D,    KC_R,    KC_W,    KC_B,                      KC_J,    KC_F,    KC_U,    KC_P,   KC_SCLN, KC_QUOT,
  KC_TAB,   KC_A,   KC_S,    KC_H,    KC_T,    KC_G,                      KC_Y,    KC_N,    KC_E,    KC_O,   KC_I,    KC_BSPC,
  MO(2),    KC_Z,   KC_X,    KC_M,    KC_C,    KC_V,   KC_MUTE,   KC_MPLY,KC_K,    KC_L,    KC_COMM, KC_DOT, KC_SLSH, KC_RGUI,
                    XXXXXXX, XXXXXXX, KC_LALT, KC_ENT, KC_LCTRL,  MO(3),  KC_SPC,  KC_RSFT, XXXXXXX, TG(1)
),
/*
 * WORKMAN
 * ,-----------------------------------------.                    ,-----------------------------------------.
